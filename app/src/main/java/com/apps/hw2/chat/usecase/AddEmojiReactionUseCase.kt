...
class AddEmojiReactionUseCase @Inject constructor(
    private val streamsService: StreamsService,
    private val appDatabase: AppDatabase
) : IAddEmojiReactionUseCase {
    override fun execute(
        ...
        return streamsService.addEmojiReaction(messageId, emojiName, emojiCode, reactionType)
            .flatMap {
